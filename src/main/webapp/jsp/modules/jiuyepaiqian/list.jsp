...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">就业派遣管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>就业派遣列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">就业派遣列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										派遣去向
									</label>
									<input type="text" id="paiqianquxiangSearch" class="form-control form-control-sm" placeholder="请输入派遣去向" aria-controls="tableId">
                                    <label>
                                        是否通过
                                    </label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('paiqianquxiang')">派遣去向<i id="paiqianquxiangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xueshengdangan')">学生档案<i id="xueshengdanganIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xueshenghukou')">学生户口<i id="xueshenghukouIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#paiqianquxiangSearch').val() != null && $('#paiqianquxiangSearch').val() != ''){
				searchForm.paiqianquxiang ="%" +  $('#paiqianquxiangSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("jiuyepaiqian/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				paiqianquxiang : searchForm.paiqianquxiang,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var paiqianquxiangCell  = document.createElement('td');

						 paiqianquxiangCell.innerHTML = item.paiqianquxiang;

			row.appendChild(paiqianquxiangCell);
			var xueshengdanganCell  = document.createElement('td');

						 xueshengdanganCell.innerHTML = item.xueshengdangan;

			row.appendChild(xueshengdanganCell);
			var xueshenghukouCell  = document.createElement('td');

						 xueshenghukouCell.innerHTML = item.xueshenghukou;

			row.appendChild(xueshenghukouCell);
			var paiqianfanganCell  = document.createElement('td');
		...
		function sh(){
			...
			httpJson("jiuyepaiqian/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jiuyepaiqian/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jiuyepaiqian");
