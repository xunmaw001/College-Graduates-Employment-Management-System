		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑用人单位</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>用人单位管理</span></li>
								<li class="breadcrumb-item active"><span>编辑用人单位</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">用人单位信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>企业地点</label>
										<input name="qiyedidian" id="qiyedidian" name="qiyedidian" class="form-control" placeholder="企业地点">
									</div>
									<div class="form-group col-md-6">
										<label>负责人</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yongrendanwei/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("yongrendanwei/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yongrendanwei/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yongrendanwei/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("yongrendanwei"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#qiyedidian").val(ruleForm.qiyedidian);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.qiyedidian != null && res.data.qiyedidian != ''){

						$("#qiyedidian").val(res.data.qiyedidian);
						$("#qiyedidian").attr('readonly','readonly');
					}
