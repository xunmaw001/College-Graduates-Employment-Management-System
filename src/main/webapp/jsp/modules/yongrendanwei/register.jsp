...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20220123/afbe7e3c22544a37a5655d6316441d83.png) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		border-width: 5px;
		border-style: solid;
		border-color: rgba(230, 198, 154, 1);
    ...
    #registerForm .emails .btn {
        ...
        background-color: rgba(230, 198, 154, 1);
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="qiyezhanghao" placeholder="企业账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="qiyemingcheng" placeholder="企业名称" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">企业地点</label> 
							<input  name="qiyedidian" placeholder="企业地点" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">负责人</label> 
							<input  name="fuzeren" placeholder="负责人" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="qiyeyouxiang" placeholder="企业邮箱" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "yongrendanwei/register";
				$.ajax({ 
					type: "POST",
					url: url,
