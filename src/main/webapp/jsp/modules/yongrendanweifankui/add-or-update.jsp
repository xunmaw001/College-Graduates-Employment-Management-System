...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑用人单位反馈</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>用人单位反馈管理</span></li>
								<li class="breadcrumb-item active"><span>编辑用人单位反馈</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">用人单位反馈信息</h3>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<div id="fankuishijianDate" class="input-append date form_datetime">
											<input id="fankuishijian-input" name="fankuishijian" size="20" type="text" readonly>
											...
											<div class="form-group  col-md-12" >
												<label>反馈内容</label>
												<div><div class="upload"><input id="fankuineirongupload" name="file" type="file">选择文件</div>
												<script id="fankuineirongEditor" type="text/plain"></script>
	...
	<script>
		...
		var tableName = "yongrendanweifankui";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yongrendanweifankui/info/" + id,
		...
		function upload(){
			$('#fankuineirongupload').fileupload({
				...
				dataType: 'json',
					...
					UE.getEditor('fankuineirongEditor').execCommand('insertHtml','<img src=\"'+ baseUrl +'upload/'+ data.result.file + '\" width=900 height=560>');					
				}
			});
		}  
		//取消 
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				if(crossrefid && crossuserid) {
					...
					http("yongrendanweifankui/page","GET",{
						page:1,
						limit:10,
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yongrendanweifankui/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getContent(){
			if(UE.getEditor('fankuineirongEditor').hasContents()){
				$('#fankuineirong-input').attr('value',UE.getEditor('fankuineirongEditor').getContent());
			}
		}
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yongrendanweifankui/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#fankuishijian-input").val(getCurDateTime());
		...
		function calculationSE(colName){
			//单列求和接口
			http("yongrendanweifankui"+colName,"GET",{
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.fankuineirong != null && res.data.fankuineirong != ''){
                        ...
                        var fankuineirongMes = '' + res.data.fankuineirong;
                        var fankuineirongUeditor = UE.getEditor('fankuineirongEditor');
                        fankuineirongUeditor.ready(function() {
                            fankuineirongUeditor.setContent(fankuineirongMes);
                        });
