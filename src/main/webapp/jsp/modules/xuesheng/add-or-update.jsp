...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>学生手机</label>
										<input name="xueshengshouji" id="xueshengshouji" name="xueshengshouji" class="form-control" placeholder="学生手机">
									</div>
									<div class="form-group col-md-6">
										<label>院系</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#xueshengshouji").val(ruleForm.xueshengshouji);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xueshengshouji != null && res.data.xueshengshouji != ''){

						$("#xueshengshouji").val(res.data.xueshengshouji);
						$("#xueshengshouji").attr('readonly','readonly');
					}
