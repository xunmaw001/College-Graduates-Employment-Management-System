...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>头像</th>
											<th onclick="sort('xueshengshouji')">学生手机<i id="xueshengshoujiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xueshengshoujiCell  = document.createElement('td');

						 xueshengshoujiCell.innerHTML = item.xueshengshouji;

			row.appendChild(xueshengshoujiCell);
