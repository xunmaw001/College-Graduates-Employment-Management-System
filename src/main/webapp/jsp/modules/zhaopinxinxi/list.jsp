...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="zhaopingangweiSearch" class="form-control form-control-sm" placeholder="请输入招聘岗位" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xinzifanwei')">薪资范围<i id="xinzifanweiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xinzifanweiCell  = document.createElement('td');

						 xinzifanweiCell.innerHTML = item.xinzifanwei;

			row.appendChild(xinzifanweiCell);
